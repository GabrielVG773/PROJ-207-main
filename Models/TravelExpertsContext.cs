...
public partial class TravelExpertsContext : DbContext
{
    ...
    public virtual DbSet<ProductSupplier> ProductsSuppliers { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PackageProductSupplierId).HasName("PK__Packages__53E8ED99028B8584");
            ...
            entity.HasIndex(e => new { e.PackageId, e.ProductSupplierId }, "UQ__Packages__29CA8E95AF168840").IsUnique();
